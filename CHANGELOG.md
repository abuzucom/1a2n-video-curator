...
- Removed the windowsHide option from the Windows folder-picker child
  process in server.js. The option set SW_HIDE in process startup info.
  That flag left FolderBrowserDialog permanently hidden.
