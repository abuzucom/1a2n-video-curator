  ...
  return new Promise((resolve, reject) => {
    ...
    if (process.platform === 'win32') {
      child = execFile('powershell.exe', [
        ...
        '-Sta',
        '-Command',
        // A TopMost owner form brings the dialog to the foreground
        // instead of opening behind the browser window. Deliberately no
        // '-WindowStyle Hidden' and no 'windowsHide: true' here: both
        // flags set SW_HIDE in the process startup info, which causes
        // Windows to create WinForms dialogs permanently hidden and
        // hanging indefinitely waiting for interaction.
